<%-- 
    Document   : contact
    Created on : Apr 30, 2017, 9:03:40 PM
    Author     : ABHISHEK
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="studentPannel/stpanel.css" />
        <style>
            #bodyy{
                color:#009999;
            }
    ...
    <body>
        <!-- HEADER -->
                                    ...
                                    <nav id="access" class="access" role="navigation">
                                        <div id="menu" class="menu">
                                            <ul id="tiny">
                                                ...
                                                <li><a href="studentPannel/studentPannel.jsp">Student Zone</a></li>
            ...
            <div id="headpane">
                <h1 style="float:left; margin-left: 50px;">Contact Us Panel</h1>
            </div>
            <div id="bodyCp">
                <img src="studentPannel/st_image.jpg" height="100%" width="100%">
            </div>
