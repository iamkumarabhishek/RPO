 ...
 * @author ABHISHEK
 */
public class dwnldStuPrf extends HttpServlet {
...
"}");
            ...
            //make query
            String query = "select * from studentReg where uname = '"+name+"' and password = '"+password+"'";
            //execute query
            boolean flag = false;
            ...
            while(rs.next()){
                ...
                if(flag == true){
                    ...
                    pw.println("<h2>Hello,&nbsp; "+fname+"&nbsp;"+lname+"</h2><br>");
                    pw.println("<h3>Dear Student,</h3>");
